export default {
    accounts: {
      ...
      modelTestFailed: 'Model {model} failed: {error}',
      failedModels: 'Failed models',
      someModelsFailed: '{count} model(s) failed the test',
      removeFailedModel: 'Remove model',
      removeFailedModelError: 'Failed to remove model {model}: {error}',
