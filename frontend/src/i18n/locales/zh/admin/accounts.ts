export default {
    accounts: {
      ...
      testingModel: '正在测试模型：{model}',
      modelTestFailed: '模型 {model} 测试失败：{error}',
      failedModels: '测试失败的模型',
      someModelsFailed: '有 {count} 个模型测试失败',
      removeFailedModel: '删除此模型',
      removeFailedModelError: '删除模型 {model} 失败：{error}',
      reAuthorize: '重新授权',
      refreshToken: '刷新令牌',
      noAccountsYet: '暂无账号',
